...
public class ApplicationMain {
    ...
    public static void main(String[] args) {
        ...
        ActorRef pingActorWithMailbox = system.actorOf(PingActor.props().withMailbox("akka.actor.bounded-mailbox"), "pingActor");

        pingActorWithMailbox.tell(new PingActor.Initialize(), null);

        ActorRef pongActor = system.actorOf(PingActor.props().withMailbox("akka.actor.bounded-mailbox"), "pingActor2");
